...
func Test_listFirewallRules_returns_error_when_token_is_missing(t *testing.T) {
	// Arrange
	t.Setenv("CLOUDFLARE_API_TOKEN", "")

	// Act
	result, _, err := listFirewallRules(context.Background(), &mcp.CallToolRequest{}, ListFirewallRulesInput{ZoneID: "abc123"})
...
func Test_ListFirewallRulesInput_has_zero_value_defaults(t *testing.T) {
	// Arrange & Act
	input := ListFirewallRulesInput{}

	// Assert
	if input.ZoneID != "" || input.Page != 0 || input.PerPage != 0 {
...
func Test_listRulesets_returns_error_when_token_is_missing(t *testing.T) {
	// Arrange
	t.Setenv("CLOUDFLARE_API_TOKEN", "")

	// Act
	result, _, err := listRulesets(context.Background(), &mcp.CallToolRequest{}, ListRulesetsInput{ZoneID: "abc123"})
...
func Test_getRateLimit_returns_error_when_token_is_missing(t *testing.T) {
	// Arrange
	t.Setenv("CLOUDFLARE_API_TOKEN", "")

	// Act
	result, _, err := getRateLimit(context.Background(), &mcp.CallToolRequest{}, GetRateLimitInput{ZoneID: "abc123", RateLimitID: "rl123"})
