...
func Test_CheckToken_returns_error_when_token_is_empty(t *testing.T) {
	// Arrange
	apiToken := ""
...
func Test_CheckToken_returns_nil_when_token_is_set(t *testing.T) {
	// Arrange
...
func Test_APIErrorResult_joins_multiple_errors_with_semicolons(t *testing.T) {
	// Arrange
	errs := []Error{
...
func Test_APIErrorResult_includes_code_and_message_for_single_error(t *testing.T) {
	// Arrange
	errs := []Error{
...
func Test_FormatResult_returns_pretty_printed_JSON(t *testing.T) {
	// Arrange
	cfResp := &Response{
		Success: true,
...
func Test_FormatResult_returns_error_for_invalid_JSON(t *testing.T) {
	// Arrange
	cfResp := &Response{
		Success: true,
